...
async function getFbVideoInfo(videoUrl, cookie, useragent) {
    return new Promise((resolve, reject) => {
        ...
        fetch(videoUrl, { headers })
            ...
            if (sdMatch && sdMatch[1]) {
                const result = {
                    ...
                    title: titleMatch && titleMatch[1]
                        ...
                        : (_b = (_a = data.match(/<title>(.*?)<\/title>/)) === null || _a === void 0 ? void 0 : _a[1]) !== null && _b !== void 0 ? _b : "",
                ...
                resolve(Object.assign(Object.assign({}, result), { sdSize, hdSize }));
            }
            else {
            ...
            .catch((err) => {
            reject(`Unable to fetch video information. Fetch Error: ${err.message}`);
        });
    });
}
